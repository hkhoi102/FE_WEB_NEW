...
const AdminSidebar = ({ currentTab, onTabChange }: AdminSidebarProps) => {
  ...
  const [expandedItems, setExpandedItems] = useState<string[]>(
    isManager ? ['management', 'warehouses', 'orders'] : ['management', 'warehouses', 'orders', 'statistics']
  )
  ...
  const getMenuItems = (): MenuItem[] => {
    const baseMenuItems: MenuItem[] = [
        ...
        children: [
          {
            ...
            children: [
              ...
              ...(isManager ? [] : [{ id: 'inventory-import-export-list', label: 'Danh sách phiếu nhập xuất', icon: 'M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' }]),
      ...
      },
      {
        ...
        children: [
          { id: 'order-processing', label: 'Đơn hàng', icon: 'M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
